...
export const bullRecordSchema = z.object({
  ...
  milkLbsReliability: z.string().optional(),
  fatLbs: z.string().optional(),
  fatLbsReliability: z.string().optional(),
  fatPercent: z.string().optional(),
  proteinLbs: z.string().optional(),
  proteinLbsReliability: z.string().optional(),
  proteinPercent: z.string().optional(),
  combinedFatProtein: z.string().optional(),
  combinedFatProteinReliability: z.string().optional(),

  productiveLife: z.string().optional(),
  productiveLifeReliability: z.string().optional(),
  daughterPregnancyRate: z.string().optional(),
  daughterPregnancyRateReliability: z.string().optional(),
  sireConceptionRate: z.string().optional(),
  heiferConceptionRate: z.string().optional(),
  heiferConceptionRateReliability: z.string().optional(),
  cowConceptionRate: z.string().optional(),
  cowConceptionRateReliability: z.string().optional(),
  betaCasein: z.string().optional(),
  transitionRight: z.string().optional(),
  somaticCellScore: z.string().optional(),
  somaticCellScoreReliability: z.string().optional(),
  sireCalvingEase: z.string().optional(),
  sireCalvingEaseReliability: z.string().optional(),
  daughterCalvingEase: z.string().optional(),
  daughterCalvingEaseReliability: z.string().optional(),
  sireStillbirth: z.string().optional(),
  sireStillbirthReliability: z.string().optional(),
  daughterStillbirth: z.string().optional(),
  daughterStillbirthReliability: z.string().optional(),

  mast: z.string().optional(),
  mastReliability: z.string().optional(),
  metr: z.string().optional(),
  metrReliability: z.string().optional(),
  keto: z.string().optional(),
  ketoReliability: z.string().optional(),
  repl: z.string().optional(),
  replReliability: z.string().optional(),
  dsab: z.string().optional(),
  dsabReliability: z.string().optional(),
  mfev: z.string().optional(),
  mfevReliability: z.string().optional(),
