        ...
        <Card title={strings.fertilityTitle} style={styles.sectionCard}>
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              <Text style={styles.tableCol}>{health.cowConceptionRateReliability || 0}%</Text>
            </View>
          </View>
        </Card>
        ...
        <Card title={strings.calvingTitle} style={styles.sectionCard}>
          <View style={styles.table}>
            ...
            <View style={[styles.tableRow, styles.altRow]}>
              ...
              <Text style={styles.tableCol}>{health.daughterStillbirthReliability || 0}%</Text>
            </View>
          </View>
        </Card>
        ...
        <Card title={strings.healthTitle} style={styles.sectionCard}>
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              <Text style={styles.tableCol}>{health.mfevReliability || 0}%</Text>
            </View>
          </View>
        </Card>
