...
let mockBulls = [
  {
    ...
    cdcbChart: {
      ...
      production: {
        milkLbs: 1250,
        milkLbsReliability: 98,
        fatLbs: 72,
        fatLbsReliability: 98,
        fatPercent: 0.08,
        proteinLbs: 48,
        proteinLbsReliability: 98,
        proteinPercent: 0.03,
        combinedFatProtein: 120,
        combinedFatProteinReliability: 98
      },
      health: {
        productiveLife: 4.8,
        productiveLifeReliability: 95,
        daughterPregnancyRate: 0.2,
        daughterPregnancyRateReliability: 92,
        sireConceptionRate: 1.5,
        heiferConceptionRate: 1.5,
        heiferConceptionRateReliability: 88,
        cowConceptionRate: 0.8,
        cowConceptionRateReliability: 88,
        betaCasein: 'A2A2',
        transitionRight: 3,
        somaticCellScore: 2.70,
        somaticCellScoreReliability: 93,
        sireCalvingEase: 1.9,
        sireCalvingEaseReliability: 94,
        daughterCalvingEase: 2.1,
        daughterCalvingEaseReliability: 94,
        sireStillbirth: 5.5,
        sireStillbirthReliability: 91,
        daughterStillbirth: 6.2,
        daughterStillbirthReliability: 91,
        mast: 3.0,
        mastReliability: 75,
        metr: 1.8,
        metrReliability: 75,
  ...
  },
  {
    ...
    cdcbChart: {
      ...
      production: {
        milkLbs: 1100,
        milkLbsReliability: 95,
        fatLbs: 65,
        fatLbsReliability: 95,
        fatPercent: 0.06,
        proteinLbs: 42,
        proteinLbsReliability: 95,
        proteinPercent: 0.02,
        combinedFatProtein: 107,
        combinedFatProteinReliability: 95
      },
      health: {
        productiveLife: 4.2,
        productiveLifeReliability: 92,
        daughterPregnancyRate: 0.5,
        daughterPregnancyRateReliability: 89,
        sireConceptionRate: 2.0,
        heiferConceptionRate: 2.0,
        heiferConceptionRateReliability: 85,
        cowConceptionRate: 1.2,
        cowConceptionRateReliability: 85,
        betaCasein: 'A1A2',
        transitionRight: 4,
        somaticCellScore: 2.80,
        somaticCellScoreReliability: 90,
        sireCalvingEase: 2.1,
        sireCalvingEaseReliability: 91,
        daughterCalvingEase: 1.9,
        daughterCalvingEaseReliability: 91,
        sireStillbirth: 5.8,
        sireStillbirthReliability: 88,
        daughterStillbirth: 6.0,
        daughterStillbirthReliability: 88,
        mast: 2.5,
        mastReliability: 70,
        metr: 1.2,
        metrReliability: 70,
  ...
  {
    bullId: 'bull_29ho19200',
    brandId: 'brand_abs',
    brandName: 'ABS Semen',
    bullName: 'ABS Meteor',
    naabCode: '29HO19200',
    registrationNumber: 'HO840003151009988',
    tpi: '2680',
    breed: 'Jersey',
    ...
    cdcbChart: {
      ...
      production: {
        milkLbs: 850,
        milkLbsReliability: 93,
        fatLbs: 58,
        fatLbsReliability: 93,
        fatPercent: 0.12,
        proteinLbs: 35,
        proteinLbsReliability: 93,
        proteinPercent: 0.05,
        combinedFatProtein: 93,
        combinedFatProteinReliability: 93
      },
      health: {
        productiveLife: 5.0,
        productiveLifeReliability: 90,
        daughterPregnancyRate: 1.0,
        daughterPregnancyRateReliability: 87,
        sireConceptionRate: 1.0,
        heiferConceptionRate: 1.8,
        heiferConceptionRateReliability: 82,
        cowConceptionRate: 1.0,
        cowConceptionRateReliability: 82,
        betaCasein: 'A2A2',
        transitionRight: 5,
        somaticCellScore: 2.65,
        somaticCellScoreReliability: 88,
        sireCalvingEase: 1.8,
        sireCalvingEaseReliability: 89,
        daughterCalvingEase: 2.0,
        daughterCalvingEaseReliability: 89,
        sireStillbirth: 5.2,
        sireStillbirthReliability: 86,
        daughterStillbirth: 5.9,
        daughterStillbirthReliability: 86,
        mast: 1.8,
        mastReliability: 65,
        metr: 0.9,
        metrReliability: 65,
  ...
  const completedBull = {
    ...
    cdcbChart: {
      ...
      production: {
        ...
        milkLbsReliability: parseInt(bullData.milkLbsReliability) || 0,
        fatLbs: parseFloat(bullData.fatLbs) || 0,
        fatLbsReliability: parseInt(bullData.fatLbsReliability) || 0,
        fatPercent: parseFloat(bullData.fatPercent) || 0,
        proteinLbs: parseFloat(bullData.proteinLbs) || 0,
        proteinLbsReliability: parseInt(bullData.proteinLbsReliability) || 0,
        proteinPercent: parseFloat(bullData.proteinPercent) || 0,
        combinedFatProtein: parseFloat(bullData.combinedFatProtein) || 0,
        combinedFatProteinReliability: parseInt(bullData.combinedFatProteinReliability) || 0
      },
      health: {
        productiveLife: parseFloat(bullData.productiveLife) || 0,
        productiveLifeReliability: parseInt(bullData.productiveLifeReliability) || 0,
        daughterPregnancyRate: parseFloat(bullData.daughterPregnancyRate) || 0,
        daughterPregnancyRateReliability: parseInt(bullData.daughterPregnancyRateReliability) || 0,
        ...
        heiferConceptionRateReliability: parseInt(bullData.heiferConceptionRateReliability) || 0,
        cowConceptionRate: parseFloat(bullData.cowConceptionRate) || 0,
        cowConceptionRateReliability: parseInt(bullData.cowConceptionRateReliability) || 0,
        ...
        somaticCellScoreReliability: parseInt(bullData.somaticCellScoreReliability) || 0,
        sireCalvingEase: parseFloat(bullData.sireCalvingEase) || 0,
        sireCalvingEaseReliability: parseInt(bullData.sireCalvingEaseReliability) || 0,
        daughterCalvingEase: parseFloat(bullData.daughterCalvingEase) || 0,
        daughterCalvingEaseReliability: parseInt(bullData.daughterCalvingEaseReliability) || 0,
        sireStillbirth: parseFloat(bullData.sireStillbirth) || 0,
        sireStillbirthReliability: parseInt(bullData.sireStillbirthReliability) || 0,
        daughterStillbirth: parseFloat(bullData.daughterStillbirth) || 0,
        daughterStillbirthReliability: parseInt(bullData.daughterStillbirthReliability) || 0,
        mast: parseFloat(bullData.mast) || 0,
        mastReliability: parseInt(bullData.mastReliability) || 0,
        metr: parseFloat(bullData.metr) || 0,
        metrReliability: parseInt(bullData.metrReliability) || 0,
        keto: parseFloat(bullData.keto) || 0,
        ketoReliability: parseInt(bullData.ketoReliability) || 0,
        repl: parseFloat(bullData.repl) || 0,
        replReliability: parseInt(bullData.replReliability) || 0,
        dsab: parseFloat(bullData.dsab) || 0,
        dsabReliability: parseInt(bullData.dsabReliability) || 0,
        mfev: parseFloat(bullData.mfev) || 0,
        mfevReliability: parseInt(bullData.mfevReliability) || 0
      },
      conformation: {
